...
% PREVIEW SETTINGS
settingsStruct.prevExpTime = 50; % in ms
settingsStruct.prevBinSize = 2; % Note: 1=1x1, 2=2x2, 3=4x4pixels
settingsStruct.prevPixClock = 1; % Note: 1=12, 2=24MS/s
settingsStruct.prevGain = 2; % Note: 1=1.00, 2=0.67ADU/e-

% CAPTURE SETTINGS
settingsStruct.capExpTime = 150; % in ms
settingsStruct.capBinSize = 1; % Note: 1=1x1, 2=2x2, 3=4x4pixels
settingsStruct.capPixClock = 1; % Note: 1=12, 2=24MS/s
settingsStruct.capGain = 1; % Note: 1=1.00, 2=0.67ADU/e-
settingsStruct.capNumFrames = 1; % actually it's the NUMBER of frame PAIRS
